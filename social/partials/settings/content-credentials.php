    ...
    <div class="p-3">
        ...
        <div class="content-block mb-3">
            ...
            <form method="post" id="content-form-changepassword">
                <input class="form-control mr-2 mb-2" id="content-input-oldpassword" type="password" placeholder="Current password" required />

                <div class="form-inline mb-sm-2">
                    <input class="form-control mr-sm-2 mb-2 mb-sm-0" id="content-input-newpassword" type="password" placeholder="New password" required />
                    <input class="form-control mb-2 mb-sm-0" id="content-input-repeatpassword" type="password" placeholder="Repeat password" required />
                </div>
