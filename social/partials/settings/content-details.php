    ...
    <div class="p-3">
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changefulldescription" method="post">
                <textarea class="form-control mb-2" id="content-input-fulldescription" rows="5" maxlength="1000"><?php echo $userDetails['full_description'] ?? ''; ?></textarea>
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changecontactmethods" method="post">
                <textarea class="form-control mb-2" id="content-input-contactmethods" rows="4" maxlength="500"><?php echo $userDetails['contact_methods'] ?? ''; ?></textarea>
                <div class="d-flex justify-content-end mb-2">
                    <small class="letters-counter text-muted">
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changefavouritemusic" method="post">
                <textarea class="form-control mb-2" id="content-input-favouritemusic" rows="4" maxlength="500"><?php echo $userDetails['favourite_music'] ?? ''; ?></textarea>
                <div class="d-flex justify-content-end mb-2">
                    <small class="letters-counter text-muted">
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changefavouritemovies" method="post">
                <textarea class="form-control mb-2" id="content-input-favouritemovies" rows="4" maxlength="500"><?php echo $userDetails['favourite_movies'] ?? ''; ?></textarea>
                <div class="d-flex justify-content-end mb-2">
                    <small class="letters-counter text-muted">
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changefavouritegames" method="post">
                <textarea class="form-control mb-2" id="content-input-favouritegames" rows="4" maxlength="500"><?php echo $userDetails['favourite_games'] ?? ''; ?></textarea>
                <div class="d-flex justify-content-end mb-2">
                    <small class="letters-counter text-muted">
