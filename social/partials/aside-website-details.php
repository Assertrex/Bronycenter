<section class="fancybox mt-lg-0 mb-0">
    <h6 class="text-center mb-0">Website details</h6>

    <div class="p-3 text-center" style="font-size: 14px;">
        <ul class="mb-2 pl-0 list-unstyled">
            <li>Version: <?php echo $websiteVersion['version']; ?> (<?php echo $websiteVersion['date']; ?>)</li>
        ...
        <ul class="mb-0 pl-0 list-unstyled">
            <li>BronyCenter &copy; 2017 - 2018</li>
