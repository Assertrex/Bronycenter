    ...
    <div class="p-3">
        ...
        <div class="content-block mb-3">
            ...
            <form method="post" id="content-form-changedisplayname">
                <p class="mb-3" style="font-size: .875em;">You can change your display name <b><?php echo 3 - $userDetails['displayname_changes']; ?></b> more times.</p>

                <input class="form-control mb-2" id="content-input-displayname" type="text" placeholder="Display name" value="<?php echo $userDetails['display_name'] ?? ''; ?>" maxlength="32" autocomplete="off" required />
        ...
        <div class="content-block mb-3">
            ...
            <form method="post" id="content-form-changegender">
                <select class="form-control mb-2" id="content-input-gender" style="flex: 1;">
                    <option value="0"<?php echo ($userDetails['gender'] == 0) ? 'selected' : ''; ?>>Unknown</option>
                    <option value="1"<?php echo ($userDetails['gender'] == 1) ? 'selected' : ''; ?>>Male</option>
                    <option value="2"<?php echo ($userDetails['gender'] == 2) ? 'selected' : ''; ?>>Female</option>
                </select>
                <button class="btn btn-outline-primary btn-block" type="submit">Change</button>
            </form>
        </div>
        ...
        <div class="content-block mb-3">
            ...
            <form method="post" id="content-form-changebirthdate">
                <div class="form-inline">
                    ...
                    <input type="number" class="form-control mr-sm-2 mb-2" id="content-input-birthday" placeholder="Day" min="0" max="31" value="<?php echo $userDetails['birthdate_temp']['day'] ?? ''; ?>" autocomplete="off" />
                    <input type="number" class="form-control mb-2" id="content-input-birthyear" placeholder="Year" min="0" max="<?php echo date('Y') - 13; ?>" value="<?php echo $userDetails['birthdate_temp']['year'] ?? ''; ?>" autocomplete="off" />
                </div>
                <div>
                    <button class="btn btn-outline-primary btn-block" type="submit">Change</button>
                </div>
        ...
        <div class="content-block mb-3">
            ...
            <form method="post" id="content-form-changecity">
                <div class="form-inline mb-sm-2">
                    <input class="form-control mr-sm-2 mb-2 mb-sm-0" id="content-input-city" type="text" placeholder="City name" value="<?php echo $userDetails['city'] ?? ''; ?>" maxlength="32" autocomplete="off" />
                    <input class="form-control mb-2 mb-sm-0" type="text" placeholder="Country name" value="<?php echo $utilities->getCountryName($userDetails['country_code']); ?>" disabled />
                </div>
        ...
        <div class="content-block mb-3">
            ...
            <div class="d-flex align-items-center align-items-sm-end">
                <div class="mr-2">
                    <img src="../media/avatars/<?php echo $userDetails['avatar'] ?? 'default'; ?>/defres.jpg" class="rounded" id="content-currentavatar" />
                </div>
                <div style="flex: 1;">
        ...
        <div class="content-block mb-3">
            ...
            <form id="content-form-changeshortdescription" method="post">
                <textarea class="form-control mb-2" id="content-input-shortdescription" rows="3" maxlength="160"><?php echo $userDetails['short_description'] ?? ''; ?></textarea>
                <div class="d-flex justify-content-end mb-2">
                    <small class="letters-counter text-muted">
