...
class Image
{
    ...
    public function createAvatar($file, $hash)
    {
        ...
        try {
            ...
            file_put_contents('../../media/avatars/' . $hash . '/maxres.jpg', $max_image);
            file_put_contents('../../media/avatars/' . $hash . '/defres.jpg', $def_image);
            file_put_contents('../../media/avatars/' . $hash . '/minres.jpg', $min_image);
        } catch (Exception $e) {
